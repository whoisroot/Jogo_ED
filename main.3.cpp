...
//________________________________________Fim_Allegro______________________________________________________
    ...
    do{
        ...
        while(ing = Ingredientes->Percorre()){
            if(ing == 1)
                draw_sprite(buffer, HAMBURGUER_BAIXO, (width - HAMBURGUER_BAIXO->w)/2, heigth/2);
            else if(ing == 2)
                draw_sprite(buffer, CARNE, (width-CARNE->w)/2, heigth/2);
            else if(ing == 3)
                draw_sprite(buffer, QUEIJO, (width - QUEIJO->w)/2, heigth/2);
            else if(ing == 4)
                draw_sprite(buffer, BACON, (width - BACON->w)/2, heigth/2);
            else if(ing == 5)
                draw_sprite(buffer, ALFACE, (width - ALFACE)/2, heigth/2);
            else if(ing == 6)
                draw_sprite(buffer, TOMATE_ICONE);
            else if(ing == 7)
                draw_sprite(buffer, PICLES, (width - PICLES->w)/2, heigth/2);
            else if(ing == 8)
                draw_sprite(buffer, HAMBURGUER_CIMA), (width - HAMBURGUER_CIMA->w)/2, heigth/2);
